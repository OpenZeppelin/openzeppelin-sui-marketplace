# 03 - Shop Object + Capability Auth

**Path:** [Learning Path](./) > 03 Shop Object + Capability Auth
...
## 10. Navigation
1. Previous: [02 Localnet + Publish](./02-localnet-publish.md)
2. Next: [04 Listings + Typed Receipts](./04-listings-receipts.md)
