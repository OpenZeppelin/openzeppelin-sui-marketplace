# 11 - Data Access + Indexing

**Path:** [Learning Path](./) > 11 Data Access + Indexing
...
## 2. Prereqs
1. Familiarity with `docs/03-shop-capabilities.md` and `docs/04-listings-receipts.md`.
...
## 9. Navigation
1. Previous: [10 PTBs + Gas + Fees](./10-ptb-gas.md)
