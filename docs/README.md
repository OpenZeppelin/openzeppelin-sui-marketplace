...
| `Coin<T>` resources | Payment as objects, not allowances | `packages/dapp/move/oracle-market/sources/shop.move` (process_purchase, pay_shop, refund_or_destroy) | `docs/09-currencies-oracles.md` |
