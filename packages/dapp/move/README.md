...
Dependencies (Pyth/Wormhole)
----------------------------
`packages/dapp/move/oracle-market` pulls Pyth and Wormhole directly from their upstream git repositories.
For localnet, Pyth is swapped to `pyth-mock` via `dep-replacements`.
