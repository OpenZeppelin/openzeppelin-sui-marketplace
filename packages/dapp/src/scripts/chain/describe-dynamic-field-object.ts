/**
 * Resolves a dynamic field entry by parent object + key and prints the child object.
 * Dynamic fields are Sui's object-based map: the parent owns child objects keyed by name.
 */
