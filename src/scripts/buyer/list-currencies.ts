...
const decodeUtf8Vector = (value: unknown): string | undefined => {
...
const formatVectorBytesAsHex = (value: unknown): string => {
  const byteArray = asNumberArray(value)
...
const formatOptionalNumericValue = (value: unknown): string | undefined => {
